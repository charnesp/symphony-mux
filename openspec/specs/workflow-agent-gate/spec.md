...
Define execution, routing, prompt assembly, and configuration constraints for workflow states with `type: agent-gate` (one runner turn then structured transition selection).
