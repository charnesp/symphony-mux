...
1. Read and follow the project's AI assistant conventions (AGENTS.md, CLAUDE.md, or similar file in the root directory).
...
- When planning: read the project conventions file (AGENTS.md, CLAUDE.md, or similar), the existing code in the area you are modifying, and any related docs.
...
## Linear tracking comment

Use a single Linear comment as a persistent tracking comment:
