...
class TestLightThemeCSSVariables:
    ...
    def test_light_theme_backgrounds_are_light(self):
        ...
        assert bg_val.startswith(("#f", "#e", "#d", "#c", "#F", "#E", "#D", "#C", "white")) or \
            bg_val in ("#ffffff", "#fafafa", "#f5f5f5", "#eeeeee"), \
    ...
    def test_light_theme_text_is_dark(self):
        ...
        assert text_val.startswith(("#1", "#2", "#3", "#0")) or \
            text_val in ("#1a1a1a", "#222222", "#333333", "black"), \
...
class TestThemeToggleButton:
    ...
    def test_toggle_button_has_aria_attributes(self):
        ...
        aria_match = re.search(r'aria-label=["\'][^"\']*theme[^"\']*["\']', DASHBOARD_HTML, re.IGNORECASE)
    ...
    def test_toggle_button_in_header_right(self):
        ...
        header_right = re.search(r'<div class="header-right">(.*?)</div>', DASHBOARD_HTML, re.DOTALL)
...
class TestThemeSwitchingJavaScript:
    ...
    def test_localstorage_theme_key(self):
        ...
        assert "stokowski-theme" in DASHBOARD_HTML, \
            "localStorage key 'stokowski-theme' not found"
...
class TestThemeTransitions:
    ...
    def test_transition_on_themed_elements(self):
        ...
        assert transition_match is not None, \
            "No transition for color properties found"
